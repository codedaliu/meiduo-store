...
CORS_ORIGIN_WHITELIST = (
    ...
    'www.meiduo.site',
    '192.168.229.148', # 用于本机测试
)
CORS_ALLOW_CREDENTIALS = True  # 允许携带cookie

#允许哪些主机访问
#  'www.meiduo.site','192.168.229.148' 新增
ALLOWED_HOSTS = ['127.0.0.1','api.meiduo.site', 'www.meiduo.site','192.168.229.148']
...
# 所有的 api.meiduo.site:8000 都是动态的请求

# api.meiduo.site:8000请求 -->nginx(nginx不能处理动态业务逻辑)
#  -->转发(socket)给了 uwsgi (可以处理)  --> django (uwsgi可以将请求转发给 django)
